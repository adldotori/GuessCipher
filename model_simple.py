...
if __name__ == '__main__':
    ...
    model_A = Model(48, 512, known_key_bits, 2)  # **********************
    model_B = Model(512, 32, 0, 2)
    
    model_A.to(device)
    model_B.to(device)

    optimizer_A = torch.optim.Adam(model_A.parameters(), lr=0.000002) 
    optimizer_B = torch.optim.Adam(model_B.parameters(), lr=0.000003) 
